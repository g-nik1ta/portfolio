const defaultState = {
    ...
    educations_translations: [
        ...
        },
        {
            ...
            description: "На даний момент я навчаюся в центральноукраїнському державному університеті імені Володимира Винниченка здобуваючи ступінь бакалавра за спеціальністю Комп'ютерні науки. Я вивчаю різноманітні технології як у сфері Backend, так і у Frontend.",
        },
        {
            id: 1,
            lang: 'en',
        ...
        },
        {
            ...
            description: "Успішно закінчив курси Frontend Developer (ReactJS), опанувавши безліч технологій, отримавши унікальні знання та створивши кілька проектів. Ознайомився з основами фреймворка React, менеджера станів redux, мови програмування JS та іншими технологіями.",
        },
        {
            id: 2,
            lang: 'en',
