const defaultState = {
    ...
    companies_translations: [
        ...
        },
        {
            ...
            description: 'Проходив стажування як Frontend розробка, брав участь у створенні веб-додатків та сайтів. Як основний фреймворк був обраний Vue, але крім цього мав справу з такими технологіями як Vuex, Vuetify, JavaScript та багато іншого. Також отримав унікальний досвід у роботі з авторизацією з використанням системи керування ідентифікацією та доступом – Keycloak.'
        },
        {
            id: 2,
            lang: 'en',
