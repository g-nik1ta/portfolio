const defaultState = {
    ...
    companies_translations: [
...

        {
            ...
            achievements: [
                "Реализовал динамическое обновление данных в реальном времени (live preview в iframe), улучшив UX при настройке PWA.",
                "Создал и развивал Telegram-бота для мониторинга доменов (HTTPs, SSL, DNS записи, Cloudflare, Namecheap) с автоматическими уведомлениями.",
                "Настроил и использовал cron-процессы для автоматизации проверок и фоновых задач.",
                "Оптимизировал взаимодействие фронтенда и бэкенда, повысив отзывчивость и стабильность системы.",
                "Обеспечивал техническую поддержку пользователей, оперативно диагностируя и устраняя проблемы.",
            ],
        },
        {
            id: 11,
            ...
            achievements: [
                "Реалізував динамічне оновлення даних у реальному часі (live preview в iframe), покращивши UX при налаштуванні PWA.",
                "Створив та розвивав Telegram-бота для моніторингу доменів (HTTPs, SSL, DNS записи, Cloudflare, Namecheap) з автоматичними повідомленнями.",
                "Налаштував та використовував cron-процеси для автоматизації перевірок та фонових завдань.",
                "Оптимізував взаємодію фронтенду та бекенду, підвищивши чуйність і стабільність системи.",
                "Забезпечував технічну підтримку користувачів, оперативно діагностуючи та усуваючи проблеми.",
            ],
        },
        {
            id: 12,
            ...
            achievements: [
                "Implemented dynamic data updates in real time (live preview in iframe), improving the user experience when setting up a PWA.",
                "Created and developed a Telegram bot for domain monitoring (HTTPs, SSL, DNS records, Cloudflare, Namecheap) with automatic notifications.",
                "Configured and used cron processes to automate checks and background tasks.",
                "Optimized frontend and backend interactions, increasing system responsiveness and stability.",
                "Provided technical support to users, promptly diagnosing and resolving issues.",
            ],
        },
    ],
};
