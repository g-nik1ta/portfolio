import HtmlLogo from 'svg/skills/frontend/HtmlLogo';
import CssLogo from 'svg/skills/frontend/CssLogo';
import ReactLogo from 'svg/skills/frontend/ReactLogo';
import ReduxLogo from 'svg/skills/frontend/ReduxLogo';
import SassLogo from 'svg/skills/frontend/SassLogo';
import JSLogo from 'svg/skills/frontend/JSLogo';
import JqueryLogo from 'svg/skills/frontend/JqueryLogo';
import BootstrapLogo from 'svg/skills/frontend/BootstrapLogo';
import TypeScriptLogo from 'svg/skills/frontend/TypeScriptLogo';
import VueLogo from 'svg/skills/frontend/VueLogo';
import VuexLogo from 'svg/skills/frontend/VuexLogo';
import VuetifyLogo from 'svg/skills/frontend/VuetifyLogo';
import WebpackLogo from 'svg/skills/frontend/WebpackLogo';
...
export const othersLogo = [
    ...
    { id: 8, svg: <VsCodeLogo />, title: 'Visual Studio Code' },
